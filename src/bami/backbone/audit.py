...
from bami.backbone.utils import decode_raw, shorten, AUDIT_TYPE
...
class AuditMixin(BlockSyncMixin, metaclass=ABCMeta):
    ...
    @abstractmethod
    def apply_audit_tx(self, block: BamiBlock, audit_tx: Any) -> None:
        pass
    ...
    def process_audit(self, block: BamiBlock) -> None:
