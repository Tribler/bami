...
class PexCommunity(Community):
    ...
    def create_introduction_request(self, socket_address, extra_bytes=b""):
        extra_bytes = encode(
            random.sample(self.intro_points_for, min(len(self.intro_points_for), 10))
        )
        return super(PexCommunity, self).create_introduction_request(
    ...
    def create_introduction_response(
        ...
        return super(PexCommunity, self).create_introduction_response(
