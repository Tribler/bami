...
from python_project.noodle.caches import (
...
from python_project.noodle.settings import SecurityMode, NoodleSettings

from ipv8.community import Community
from ipv8.keyvault.crypto import default_eccrypto
from ipv8.lazy_community import (
    lazy_wrapper,
...
class NoodleCommunity(Community):
    ...
    async def process_half_block(
        ...
        if blk.type == b"spend":
            ...
            await self.sign_block(peer, linked=blk, block_type=b"claim")
    ...
    def get_peer_by_pub_key(self, peer_pub_key):
        return self.get_peer(peer_pub_key)
