...
class AuditProofPayload(Payload):
    ...
    def to_pack_list(self):
        data = [("Q", self.audit_id), ("varlenI", self.audit_proof)]
...
class AuditProofRequestPayload(Payload):
    ...
    def to_pack_list(self):
        data = [("l", self.seq_num), ("Q", self.crawl_id)]
...
class AuditProofResponsePayload(Payload):
    ...
    def to_pack_list(self):
        data = [("Q", self.audit_id), ("varlenI", self.item), ("?", self.is_proof)]
...
class PeerCrawlResponsePayload(Payload):
    ...
    def to_pack_list(self):
        data = [("Q", self.crawl_id), ("varlenI", self.chain)]
...
class HalfBlockBroadcastPayload(HalfBlockPayload):
    ...
    def __init__(
        ...
        super(HalfBlockBroadcastPayload, self).__init__(
            public_key,
            sequence_number,
            link_public_key,
            link_sequence_number,
...
class HalfBlockPairBroadcastPayload(HalfBlockPairPayload):
    ...
    def __init__(
        ...
        super(HalfBlockPairBroadcastPayload, self).__init__(
            public_key1,
            sequence_number1,
            link_public_key1,
            link_sequence_number1,
...
class DHTBlockPayload(Payload):
    ...
    PREAMBLE_OVERHEAD = (
        70  # This stems from the 64 byte signature and the 6 bytes of unsigned shorts
    )
