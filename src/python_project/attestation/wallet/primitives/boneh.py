...
def get_good_wp(n: int, p: Optional[int] = None) -> Tuple[int, FP2Value]:
    """
...
def encode(pubkey: Union[BonehPrivateKey, BonehPublicKey], m: int) -> FP2Value:
    """
...
def decode(privkey: BonehPrivateKey, msgspace: List[int], c: FP2Value) -> Optional[int]:
    """
