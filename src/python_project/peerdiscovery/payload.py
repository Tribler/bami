...
from ..messaging.payload import (
    ...
    Payload,
    decode_connection_type,
    encode_connection_type,
)
...
class SimilarityRequestPayload(Payload):
    ...
    def __init__(
        self, identifier, lan_address, wan_address, connection_type, preference_list
    ):
...
class DiscoveryIntroductionRequestPayload(IntroductionRequestPayload):
    ...
    def __init__(
        ...
        super(DiscoveryIntroductionRequestPayload, self).__init__(
            destination_address,
            source_lan_address,
            source_wan_address,
            advice,
