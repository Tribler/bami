...
from bami.plexus.backbone.audit import AuditMixin
...
from bami.plexus.payment.settings import PaymentSettings
...
class PaymentCommunity(
    PlexusCommunity, AuditMixin, BlockResponseMixin, metaclass=ABCMeta
):
    ...
    def process_witness_block(self, blk: PlexusBlock) -> None:
        """Process witness block out of order"""
