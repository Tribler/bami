...
from python_project.dht.routing import (
    Bucket,
    NODE_STATUS_BAD,
    NODE_STATUS_GOOD,
    NODE_STATUS_UNKNOWN,
...
class TestNode(TestBase):
    ...
    def test_init(self):
        ...
        self.assertEqual(
            self.node.id, unhexlify("8121e35b16b30807cdcb11f8214a5eb762c0dc19")
        )
...
class TestBucket(TestBase):
    ...
    def test_owns(self):
        pad_and_convert = lambda b: unhexlify(
            "{:<040X}".format(int(b.ljust(160, "0"), 2))
        )
