...
from python_project.attestation.wallet.primitives.boneh import (
    FP2Value,
    bilinear_group,
    decode,
    encode,
...
class TestBoneh(asynctest.TestCase):
    ...
    private_key = BonehPrivateKey.unserialize(
        unhexlify(
            "0142018eceb3e03820006219a5c5a959abfd40b042c381ff894f7c3d62"
    ...
    def test_decoding_same(self):
        ...
        self.assertEqual(
            decode(TestBoneh.private_key, [0], a), decode(TestBoneh.private_key, [0], b)
        )
