...
from python_project.attestation.wallet.bonehexact.attestation import (
    attest,
    binary_relativity,
...
class TestAttestation(asynctest.TestCase):
    ...
    private_key = BonehPrivateKey.unserialize(
        unhexlify("01011d01011401011101011c01011c01010f010103")
    )
    ...
    def test_attest(self):
        ...
        self.assertListEqual(
            [0, 1, 1, 2],
            [
                decode(self.private_key, [0, 1, 2, 3], a.bitpairs[0].compress())
    ...
    def test_create_challenge(self):
        ...
        self.assertListEqual(
            [0, 1, 1, 2],
            [create_challenge_response(self.private_key, c) for c in challenges],
        )
