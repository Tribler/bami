...
from python_project.attestation.wallet.irmaexact.algorithm import IRMAExactAlgorithm
...
class TestAlgorithm(asynctest.TestCase):
    ...
    def test_integration(self):
        ...
        attestation = algorithm.get_attestation_class().unserialize_private(
            None, attestation_blob, id_format
        )
    ...
    def test_integration_incomplete(self):
        ...
        value = '{"over16": "Yes", "over12": "Yes", "over21": "Yes", "over65": "No", "over18": "Yes"}'
        self.assertEqual(
            (algorithm.challenge_count - 1.0) / len(challenges),
            algorithm.certainty(value, aggregate),
        )
