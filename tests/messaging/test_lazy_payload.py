...
from python_project.messaging.lazy_payload import VariablePayload, vp_compile
from python_project.messaging.payload import Payload
from python_project.messaging.serialization import default_serializer
...
class TestVariablePayload(TestCase):
    def _pack_and_unpack(self, payload, instance):
        ...
        deserialized, _ = default_serializer.unpack_to_serializables(
            [payload], serialized
