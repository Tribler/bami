...
from python_project.messaging.deprecated.sorting import sortable_sort
...
class TestSorting(asynctest.TestCase):
    ...
    def test_single_str_many(self):
        ...
        """
        self.assertEqual(
            sortable_sort("".join([chr(c) for c in range(256)])),
    ...
    def test_nested_dict_double(self):
        ...
        expected = OrderedDict(
            [(1, OrderedDict([(2, 3), (4, 5)])), (7, OrderedDict([(2, 4), (4, 5)]))]
        )
