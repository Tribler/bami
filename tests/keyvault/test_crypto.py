...
from python_project.keyvault.crypto import ECCrypto
from python_project.keyvault.keys import Key, PrivateKey, PublicKey
from python_project.keyvault.private.libnaclkey import LibNaCLPK, LibNaCLSK
from python_project.keyvault.private.m2crypto import M2CryptoPK, M2CryptoSK
...
class TestECCrypto(asynctest.TestCase):
    ...
    def test_is_valid_private_bin_m2crypto(self):
        ...
        """
        self.assertTrue(
            self.ecc.is_valid_private_bin(TestECCrypto.m2crypto_key.key_to_bin())
        )
    ...
    def test_is_valid_private_bin_m2crypto_public(self):
        ...
        """
        self.assertFalse(
            self.ecc.is_valid_private_bin(TestECCrypto.m2crypto_key.pub().key_to_bin())
        )
    ...
    def test_is_valid_private_bin_nacl(self):
        ...
        """
        self.assertTrue(
            self.ecc.is_valid_private_bin(TestECCrypto.libnacl_key.key_to_bin())
        )
    ...
    def test_is_valid_private_bin_nacl_public(self):
        ...
        """
        self.assertFalse(
            self.ecc.is_valid_private_bin(TestECCrypto.libnacl_key.pub().key_to_bin())
        )
    ...
    def test_is_valid_public_bin_m2crypto(self):
        ...
        """
        self.assertFalse(
            self.ecc.is_valid_public_bin(TestECCrypto.m2crypto_key.key_to_bin())
        )
    ...
    def test_is_valid_public_bin_m2crypto_public(self):
        ...
        """
        self.assertTrue(
            self.ecc.is_valid_public_bin(TestECCrypto.m2crypto_key.pub().key_to_bin())
        )
    ...
    def test_is_valid_public_bin_nacl(self):
        ...
        """
        self.assertFalse(
            self.ecc.is_valid_public_bin(TestECCrypto.libnacl_key.key_to_bin())
        )
    ...
    def test_is_valid_public_bin_nacl_public(self):
        ...
        """
        self.assertTrue(
            self.ecc.is_valid_public_bin(TestECCrypto.libnacl_key.pub().key_to_bin())
        )
